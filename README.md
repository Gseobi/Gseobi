...
- 장기 실행 Java Daemon 설계 및 운영 경험
  - Pure Java Base / Spring Boot Base
...
- **Auth / Security** : JWT, Authorization, 암·복호화(AES, SHA, AES, MD5 / Hash)
- **Infra** : Linux
...
- ⏳ **java-daemon-collection**
  - HTTP / HTTPS / SMTP / FCM Push 기반 Daemon 시리즈 (Pure Java)
